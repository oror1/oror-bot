...
await sleep(5000)
if (args[0]) return
await parent.sendMessage(conn.user.jid, {text : '*إذا تم الإيقاف المؤقت للروبوت الفرعي أو بعد انتهاء الوظيفة، فأرسل هذه الرسالة لمحاولة الاتصال مرة أخرى*'}, { quoted: m })
